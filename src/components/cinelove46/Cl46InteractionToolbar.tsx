    ...
    <>
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[90] w-full max-w-[390px] px-3">
        <div className="bg-white/95 backdrop-blur border border-[#e8ddd4] rounded-full px-3 py-2 flex items-center justify-between shadow-[0_4px_20px_rgba(90,18,18,0.15)] gap-2">
          ...
          <button
            ...
            className="flex-1 bg-gray-100 rounded-full px-4 py-2 text-left font-barlow text-[11.5px] text-gray-500 hover:bg-gray-200/75 transition-colors cursor-pointer"
          >
            Gửi lời chúc...
          </button>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <button
              ...
              className="w-8.5 h-8.5 rounded-full bg-[#fcf5f5] hover:bg-[#fae3e3] border border-[#fae3e3] flex items-center justify-center text-[#5a1212] transition-all hover:scale-105 active:scale-95 cursor-pointer"
              title="Bắn tim"
            >
              💕
            </button>
            ...
            <div className="relative flex items-center gap-1 bg-[#5a1212] px-3 py-1.5 rounded-full text-white text-[11px] font-bold shadow-sm select-none">
              <span>👍</span>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/40 backdrop-blur-xs">
          <div className="w-full max-w-[420px] bg-white rounded-t-2xl px-6 pt-5 pb-8 flex flex-col gap-4 animate-slide-up shadow-2xl border-t border-[#e8ddd4]">
            {/* Header bar */}
            <div className="flex justify-between items-center pb-2 border-b border-gray-100">
              ...
              <button
                ...
                className="w-6 h-6 rounded-full hover:bg-gray-100 flex items-center justify-center text-gray-500 font-bold text-sm cursor-pointer"
              >
                ✕
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3 bg-[#5a1212] text-white font-barlow text-[11.5px] font-bold tracking-[2px] uppercase rounded-md shadow hover:bg-[#4c0d0d] transition-colors disabled:opacity-60"
              >
