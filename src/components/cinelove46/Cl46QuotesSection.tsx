...
export default function Cl46QuotesSection() {
  return (
    <section className="w-full px-5 py-6 bg-white flex flex-col gap-8 overflow-hidden">
      ...
      <motion.div 
        ...
        viewport={{ once: true, margin: "-50px" }}
        variants={fadeInUp}
        className="w-full bg-[#5a1212] rounded p-5 text-white flex flex-col items-center shadow-sm"
      >
      ...
      >
        {block1Images.slice(2, 6).map((img, idx) => (
          <motion.div 
            variants={fadeInUp}
            key={idx} 
            className="relative w-full aspect-square border border-gray-100 rounded overflow-hidden shadow-sm"
          >
            <Image
              src={img}
      ...
      <motion.div 
        ...
        viewport={{ once: true, margin: "-50px" }}
        variants={fadeInUp}
        className="w-full text-center py-4 relative flex flex-col items-center"
      >
      ...
      <motion.div 
        ...
        viewport={{ once: true, margin: "-50px" }}
        variants={fadeInUp}
        className="w-full bg-[#5a1212] rounded p-4 text-white text-center shadow-sm flex flex-col items-center"
      >
