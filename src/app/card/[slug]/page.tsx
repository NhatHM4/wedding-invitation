...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  const renderTemplate = () => {
    switch (wedding.template_id) {
      ...
      case 'template9':
      case 'template-9':
      case 'the-house-we-built':
        return <Template9 wedding={wedding} to={to} wishes={wishes} />;
      case 'template10':
      case 'template-10':
      case 'timelines':
      ...
      case 'template12':
      case 'template-12':
      case 'love-passport-journey':
      case 'love-passport':
        return <Template12 wedding={wedding} to={to} wishes={wishes} />;
